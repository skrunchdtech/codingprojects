...
void deleteline(string oldfilename, string newfilename, string keyword)
{
	 string line;
// open input file
ifstream in(oldfilename.c_str());
...
// rename old to new
rename(oldfilename.c_str(),oldfilename.c_str());
				...
				if(fexists("enc/users/"+ name + ".txt"))
				{
				 ...
				 cin >> choice;
					if(choice == "Yes" || choice == "yes" || choice == "Y"|| choice == "y")
					{
						...
						deleteline("enc/misc/disabled.txt", "enc/misc/temp.txt", name);
